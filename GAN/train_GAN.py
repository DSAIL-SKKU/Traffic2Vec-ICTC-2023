...
def run(algo_id, base_config, base_dir, dataset, spec, data_params={}):
    ...
    pickle_it(x_real_test, pt.join(experiment_directory, 'x_real_test.torch'))
    pickle_it(x_real_train, pt.join(experiment_directory, 'x_real_train.torch'))
    ...
    pickle_it(x_fake, pt.join(experiment_directory, 'x_fake.torch'))
...
def get_dataset_configuration(dataset):
    if dataset == 'ECG':
        ...
        generator = [('a', dict())]
    elif dataset in ['interactive', 'bulk', 'video', 'web']:
        generator = [('traffic', dict())]
    elif dataset in ['interactive_emb', 'bulk_emb', 'video_emb', 'web_emb']:
        generator = [('traffic', dict())]   
    else:
...
if __name__ == '__main__':
    ...
    parser.add_argument('-datasets', default=['interactive_emb', 'bulk_emb', 'video_emb', 'web_emb', ], nargs="+")
